...
<html>
  ...
  <!-- Bootstrap core CSS -->
  <link href="{{'assets/css/bootstrap.min.css' | relative_path}}" rel="stylesheet">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto"><li class="nav-item"><a class="nav-link js-scroll-trigger" href="#services">{% translate en.index.nav_buttons.offer %}</a></li>
		  <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#portfolio">{% translate en.index.nav_buttons.portfolio %}</a></li>
		  <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#timeline">{% translate en.index.nav_buttons.about %}</a></li>
		  <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#team">{% translate en.index.nav_buttons.team %}</a></li>
		  <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#contact">{% translate en.index.nav_buttons.contact %}</a></li>
    ...
    <div class="container">
      <div class="intro-text">
        <div class="intro-lead-in">
            <p>{% translate en.index.header_text_first %}</p>
        </div>
        <div class="intro-heading text-uppercase">
            <p>{% translate en.index.header_text_second %}</p>
        </div>
      </div>
    </div>
  </header>
    ...
    <div class="container">
	    <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading text-uppercase">{% translate en.index.services_section_text_first %}</h2>
                <h3 class="section-subheading text-muted">{% translate en.index.description %}</h3>
		  </div>
      </div>
      <div class="row text-center">
        <div class="col-md-6">
          ...
          <h4 class="service-heading"><p>{% translate en.index.services_section_text_second %}</p>
</h4>
          <div class="text-muted"><p>{% translate en.index.services_section_text_third %}</p>
</div>
        </div>
        <div class="col-md-6">
          <span class="fa-stack fa-4x">
          ...
          <h4 class="service-heading"><p>{% translate en.index.services_section_text_fourth %}</p>
</h4>
          <div class="text-muted"><p>{% translate en.index.services_section_text_five %}</p>
</div>
        </div>
      </div>
    </div>
...
<!-- About -->
  <section class="page-section" id="timeline">
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase"><p>{% translate en.index.about_text_first %}</p>
</h2>
        ...
        <div class="col-lg-12">
          <ul class="timeline">
			<li>
              ...
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4><p>{% translate en.index.about_text_second %}</p>
</h4>
                  <h4 class="subheading">{% translate en.index.about_text_third %}</h4>
                </div>
                <div class="timeline-body">
                  <div class="text-muted"><p>{% translate en.index.about_text_fourth %}</p>
</div>
                </div>
              </div>
            </li>
			<li class="timeline-inverted">
              ...
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4><p>{% translate en.index.about_text_five %}</p>
</h4>
                  <h4 class="subheading">{% translate en.index.about_text_sixth %}
</h4>
                </div>
                <div class="timeline-body">
                  <div class="text-muted"><p>{% translate en.index.about_text_seventh %}</p>
</div>
                </div>
              </div>
            </li>
			<li>
              ...
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4><p>{% translate en.index.about_text_eighth %}</p>
</h4>
                  <h4 class="subheading">{% translate en.index.about_text_nineth %}</h4>
                </div>
                <div class="timeline-body">
                  <div class="text-muted"><p>{% translate en.index.about_text_tenth %}</p>
</div>
                </div>
              </div>
            </li>
			<li class="timeline-inverted">
              <div class="timeline-image">
                <h4>{% translate en.index.about_text_eleventh %} <br> {% translate en.index.about_text_twelfth %} <br> {% translate en.index.about_text_thirteenth %}</h4>
              </div>
            </li>
          </ul>
        </div>
...
<div class="container">
  <div class="row">
	<div class="col-lg-12 text-center">
	  ...
	  <h3 class="section-subheading text-muted">It's nice to e-meet you! :)</h3>
	</div>
  </div>
  <div class="row">
	<div class="col-sm-6">
  ...
  <div class="row">
	<div class="col-lg-8 mx-auto text-center">
	  <div class="large text-muted"><p>We are here to help you create your perfect rug. If you have any questions, don't hesitate to contact us. Let's rug it! </p>
</div>
	</div>
  </div>
</div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-4">
          <ul class="list-inline social-buttons">
            ...
            <!-- <li class="list-inline-item">
              <a href="https://github.com/raviriley">
